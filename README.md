...
Features:
    ...
    -Clear separation of UI sections for readability

Possible room for improvement:
    -Eventually convert it to Node.js
        -Node.js was not necesarry with the current scope of the project.
        -Could be useful if we wanted to incorporate database interaction or server-side processing.
    -Add more input validation.
    -UI improvements
        -Increase polish and visual refinement

Note: Scheels PNG image found at https://www.pikpng.com/downpngs/hRJmooo_2017-walk-to-end-alzheimers-fargo-nd-walk/